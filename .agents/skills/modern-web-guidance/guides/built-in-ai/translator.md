...
- **Permissions Policy:** Cross-origin iframes require explicit permission.
  ...
  ```
- **Web Workers:** Currently **not supported** due to Permission Policy complexities.
- **Privacy:** No data is sent to Google servers during the translation process once the model is downloaded.

## Fallback Strategy

Translator has limited availability. Supported by: Chrome 138 (Jun 2025) and Edge 148 (May 2026). Unsupported in: Firefox and Safari.
