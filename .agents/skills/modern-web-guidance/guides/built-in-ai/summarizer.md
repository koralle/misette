...
- **Data Privacy**: No data is sent to Google; processing happens on the local device.
- **Cross-Origin**: Access can be granted to iframes using the Permission Policy.
  ```html
...
Summarizer has limited availability. Supported by: Chrome 138 (Jun 2025) and Edge 138 (Jun 2025). Unsupported in: Firefox and Safari.
