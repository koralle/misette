...
Baseline status for sibling-count() and sibling-index(): Newly available. It's been Baseline since 2026-08-18. Supported by: Chrome 138 (Jun 2025), Edge 138 (Jun 2025), Firefox 154, and Safari 26.2 (Dec 2025).
