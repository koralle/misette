...
Temporal has limited availability. Supported by: Chrome 144 (Jan 2026), Edge 144 (Jan 2026), and Firefox 139 (May 2025). Unsupported in: Safari.
...
Baseline status for Intl.DurationFormat: Newly available. It's been Baseline since 2025-03-04. Supported by: Chrome 129 (Sep 2024), Edge 129 (Sep 2024), Firefox 136 (Mar 2025), and Safari 16.4 (Mar 2023).
