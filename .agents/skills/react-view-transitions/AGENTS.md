...
> **Note:** This standalone guide is compiled from `SKILL.md` and its reference files for agents that consume a single `AGENTS.md` document. Edit the source files, not this compiled copy.
